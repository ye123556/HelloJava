...
public class KeyExample {
    public static void main(String[] args) {
        ...
        HashMap<Key, String> hashMap = new HashMap<Key, String>(); // String, String

        // 실별키 new Key(1)로 "홍길동"을 저장함
        // 사전이라고 생각하면 편함. (단어 - 뜻 / 키 - 벨류)
        Key key1 = new Key(1);
        // 해시(Hash)는 입력 데이터를 고정된 길이의 데이터로 변환된 값
        // 해시는 저장 또는 검색에서 자주 활용되는 자료구조. 보통 Hash값은 정수 형태
        System.out.println("key1.hashCode() = " + key1.hashCode());

        hashMap.put(new Key(1), "소설 '홍길동전'의 주인공이자 초능력을 부리는 인물");

        // 식별 키 new Key(1)로 "홍길동"dmf 읽어옴
        Key key2 = new Key(1);
