...
public class StringGetBytesExample {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        // 이때 기본적으로 Charset.defaltCharset()이 사용됨
        // 기본 Charset.defaultCharset()은 운영체제마다 다를 수 있음

        String str = "안녕하세요";

        // 기본 문자셋으로 인코딩과 디코딩 시작
        // 네트워크 전송자 시점
        byte[] byte1 = str.getBytes(); // UTF-8 이다.
        ...
        // UTF-8로 인코딩과 디코딩 시작
        // 네트워크 전송자 시점
        byte[] byte3 = str.getBytes(StandardCharsets.UTF_8); // EUC-KR로 인코딩된 바이트 배열 리턴
